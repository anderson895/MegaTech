  ...
  <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-lg relative">
    ...
    <form id="FrmRegister" class="space-y-6">
      ...
      <div>
        ...
        <select id="account_type" name="account_type" class="w-full mt-1 px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:border-indigo-500" required>
